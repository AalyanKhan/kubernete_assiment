...
docker build -t username/recipes-service:latest ./recipes-service

# Build Ingredients Service
docker build -t username/ingredients-service:latest ./ingredients-service
```

### 3. Push to Docker Hub
```bash
# Push Recipes Service
docker push username/recipes-service:latest

# Push Ingredients Service
docker push username/ingredients-service:latest
```
